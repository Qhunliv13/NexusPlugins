...
typedef enum {
    ...
    NXLD_PARAM_TYPE_INT32,                /**< int32_t类型 / int32_t type / int32_t-Typ */
    NXLD_PARAM_TYPE_INT64,                 /**< int64_t类型 / int64_t type / int64_t-Typ */
 ...
 * @param min_count 输出最小参数数量指针 / Output minimum parameter count pointer / Ausgabe-Mindestparameteranzahl-Zeiger
 * @param max_count 输出最大参数数量指针 / Output maximum parameter count pointer / Ausgabe-Maximalparameteranzahl-Zeiger
 * @return 成功返回0，失败返回非0 / Returns 0 on success, non-zero on failure / Gibt 0 bei Erfolg zurück, ungleich 0 bei Fehler
 */
 ...
 * @param type_name 输出类型名称缓冲区 / Output type name buffer / Ausgabe-Typnamen-Puffer
